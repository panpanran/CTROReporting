...
(function($) {
    ...
    $.jqplot.BubbleAxisRenderer.prototype.init = function(options){
        ...
        // need to estimate the effect of the radius on total axis col-md- and adjust axis accordingly.
        var col-md- = db.max - db.min;
        ...
        var minfact = minRatio * minMult/3 * col-md-;
        var maxfact = maxRatio * maxMult/3 * col-md-;
        db.max += maxfact;
        db.min -= minfact;
    };

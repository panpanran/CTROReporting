...
namespace Attitude_Loose.EW
{
    public class EWParticipant : IEWHome<Participant>
    {
        ...
        {
            string url = "https://cbiitsupport.nci.nih.gov/ewws/EWSelect?$KB=CBIIT&$login=panr2&$password=Rp0126$$&$table=participant&$lang=en&where=" + where;
        ...
        {
            string url = "https://cbiitsupport.nci.nih.gov/ewws/EWRead?$KB=CBIIT&$table=participant&$login=panr2&$password=Rp0126$$&$lang=en&id=" + id;
            string html = CTRPFunctions.GetHTMLByUrl(url);

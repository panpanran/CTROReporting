...
{
    public abstract class CTRPChart
    {
        public abstract string[] CreateBook(NpgsqlConnection conn, string startDate, string endDate, Attitude_Loose.Models.Chart chart, out string[] Xaxis, out List<Dictionary<string, string>> Yaxis);
    ...
    public class SDAWorkloadChart : CTRPChart
    {
